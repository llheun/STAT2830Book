...
\usepackage{amsmath}
\usepackage{epstopdf}
% \usepackage{Stat2830book}
\DeclareGraphicsRule{.tif}{png}{.png}{`convert #1 `dirname #1`/`basename #1 .tif`.png}

\title{Using Data Science as a Tool for Social Research \\ Stat 2830 }
\author{Statistical Computation Lab \\ Department of Statistics \\ WMU}
...
<<Ch1, child="chapters/Chapter_1/Chapter_1.Rnw",eval=FALSE>>=
@


<<Ch2, child="chapters/Chapter_2/Chapter_2.Rnw",eval=FALSE>>=
@

<<Ch3, child="chapters/Chapter_3/Chapter_3.Rnw",eval=FALSE>>=
@
...
<<WS1, child="chapters/Workshop_1/Workshop.Rnw",eval=FALSE>>=
@
