...
Statewide, the police clear by arrest 35 percent of the robberies and 42 percent of the aggravated assaults reported to them.  A researcher takes a random sample of all the robberies ($n = 207$) and aggravated assaults ($n = 178$) reported to a metropolitan police department in one year and finds that 83 of the robberies and 80 of the assaults were cleared by arrest.  Is the local robberies arrest rate significantly differenct from the statewide rate at $\alpha = 0.05$?
...
\begin{exercises}
  ...
  \begin{exercise} % 1
    ...
    In 2010, the population of Michigan on the average watched 6.2 hours of TV per day.  A researcher from Kalamazoo Health department asked; is this number the same for the citizens of Kalamazoo?  What are the hypotheses for this question?
  ...
  %   Statewide, the population as a whole watches 6.2 hours of TV per day.  A random sample of 25 senior citizens in the state report watching an average of 5.9 hours per day with a standard deviation of 0.7 hours.  Is the difference significant?
    ...
    What is your conclusion?
	  ...
	  \item There is not significant difference.
