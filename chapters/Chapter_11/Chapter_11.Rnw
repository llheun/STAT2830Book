...
\pagebreak
\begin{enumerate}
\item A random sample of 18 couples has measured the marital happiness scale in a local community.  The couples were classified by type of relationship: traditional, dual\_career, and cohabitation.  Does marital happiness vary significantly by type of relationship.
