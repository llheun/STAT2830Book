...
\begin{exercises}
  ...
  \begin{exercise} % 3
   ...
   \begin{table}[ht]
    ...
    \multicolumn{4}{c}{Age of Respondent} \\ \hline
      Confidence    & N & Mean & SD \\ \hline
       A GREAT DEAL & 411 & 47.96 & 18.305 \\
       ONLY SOME    &    952 & 49.30 & 17.096 \\
       HARDLY ANY   &   308 & 49.54 & 16.453 \\ \hline
    \end{tabular}
    \end{table}
    % \end{minipage} \hfill
   ...
   \begin{table}[ht]
    ...
    \hline
    Between Groups & 617.497 & 2 &  308.748 & 1.033 & 0.356 \\ 
    Within Groups & 498455.187 & 1668 & 298.834 &  &  \\ \hline
    Total & 499072.683 & 1670 &       &         &     \\ \hline
  ...
  \end{solution} 
    ...
    Using the information from exercise three, we must state the hypotheses about its relationship with having a gun in the home.  Based on our experience, how should we state our hypotheses?
