...
<<f11_1, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=4, fig.height=4, fig.cap="Voter Turnout by Election Type">>=
  ...
  boxplot( dt11_1$Percent.turnout ~ dt11_1$Elect.type, xlab="Election Type", ylab="Percent Turnout")
  ## aov11  <- aov(dt11_1$Percent.turnout ~ dt11_1$Elect.type)

@

Based on the above samples, do you think there is a difference among the three sample means?
...
\item Based on the above samples, does there appear to be a difference between the three sample means?
