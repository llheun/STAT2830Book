...
\begin{exercises} 
  ...
  \begin{exercise} %1 
    ...
    The next 3 questions refer to the following scenario. 
...
% Requires the booktabs if the memoir class is not being used
  ...
  \begin{exercise} % 4
    ...
    The next 3 quesions refer to the following scenario.
  ...
  \begin{exercise} % 5 
      ...
      What is the sampling distribution and critical value?
	  \begin{enumerate}
	  \samepage
