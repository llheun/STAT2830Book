...
% Requires the booktabs if the memoir class is not being used
  ...
  \begin{exercise} % 6
    ...
    Suppose about half of the public safety officers in Kalamazoo, Michigan, had finalized an individual curriculum in investigative procedures.  Did the course increase their effectiveness in clearing crimes by arrest?  The following table reports the results of the survey:
  ...
  \begin{exercise} % 9
    ...
    Given the computer output, Exercise 9.6-9,  what is the margin of error?
