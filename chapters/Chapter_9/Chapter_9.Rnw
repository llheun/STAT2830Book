...
Our new program is designed for divorce counseling.  The key feature of the program is its counselors who are married couples working in teams.  About half of all clients have been randomly assigned to this new curriculum and a half to the regular program.
...
Did the new program work?  (Or at five percent level of significance, is the proportion of divorces of clients on new program significantly lower than the proportion of divorces of clients on the regular program?)
...
\item Let's state the conclusion in non-statistical language.  We do not have sufficient statistical evidence to conclude that  the new program is more effective than the regular program in preventing divorce with 95 percent confidence. 
...
\item The conclusion in non-statistical language.  Thus, the peer program is more effective than the regular program in program in improving depression with 95 percent confidence.
