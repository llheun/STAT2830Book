...
\end{table}
  ...
  \begin{exercise}  % 10
	...
	The town Kalamazoo, Michigan, has a population of 75548 and 3549 experienced property crimes and 425 violent crimes during the past year.  Compute a rate for each type of crime per 1,000 population.
