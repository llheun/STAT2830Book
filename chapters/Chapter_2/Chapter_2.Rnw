...
Percent <- tmp5[1:5]
## Percent
barplot( Percent, ylab="Percent", xlab="Marital Status", main="GSS 2014 Survey on Marital Status", legend.text=c("Married","Widowed","Divorced","Separated","Never Married") )
