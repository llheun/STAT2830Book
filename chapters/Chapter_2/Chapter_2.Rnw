...
In social science, we use the term percent change to compare two quantities while taking into account the "sizes" of the things being compared. The comparison is expressed as a ratio and has no units. Now we can express it as percentage change  by multiplying it by 100.  For example, suppose Kalamazoo had a homicide rate of 12 in 2012 and in 2014, it had a homicide rate of 7.9 (reported as homicides per 100,000 population).
