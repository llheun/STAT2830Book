...
{\bf{Percents, proportions, rates, and ratio}} are the primary statistics for categorical data and are used for either nominal or ordinal data.
 ...
 \begin{figure}[ht]
    \centering
    \includegraphics[width=5.5cm]{chapters/Chapter_2/ext_figure/zRV2.png} % requires the graphicx package
...
The General Social Survey (GSS), conducted by the National Opinion Research Center at the University of Chicago, is a major source of data on social attitudes in the U.S.  Once each year, 1500 adults are interviewed in their homes all across the country.  The subjects are  asked their opinions about sex and marriage, attitudes toward women, welfare, foreign policy, and many other issues.  After reviewing this data from the GSS (See Table: 2.2), compute the proportion and percent of females who indicate that voting is a very important responsibility of being a citizen.
...
\begin{table}[htbp]
   ...
   \begin{tabular}{@{} | lcc | @{}} \hline % Column formatting, @{} suppresses leading/trailing space
     ...
     % \cmidrule(r){1-2} % Partial rule. (r) trims the line a little bit on the right; (l) & (lr) also possible
        Voting Importance &  Male & Female \\ \hline
          Not  & 68 & 48 \\
          Somewhat  & 160 & 134 \\
          Very  & 437 & 366 \\ 
...
Why  social scientists use ratios.
...
After reviewing this data from the GSS (See Table 2.2), compute the ratio  of males to females who indicate that voting is a very important responsibility of being a citizen.
...
This means that there is 1.19 males for each female who indicated that voting is a very important responsibility of being a citizen.
...
Suppose in 2000, a state had a homicide rate of 6.5 and in 2010 had a homicide rate of 9.2 (reported as homicides per 100,000 population).  
...
\item Frequency distribution can be constructed for all three levels of measurements.
	...
	\item interval-ratio
	\end{itemize}	
\item This data (Taable 2.3) was collected from a counseling center as reported below.  
...
<<msbar, echo=FALSE, fig.pos="ht", fig.align="center", fig.height=3, fig.cap="Marital Status Barchart from GSS 2014 Survey">>=
...
Percent <- tmp5[1:5]
## Percent
barplot( Percent, ylab="Percent", xlab="Marital Status", main="GSS 2014 Survey on Marital Status", legend.text=c("1-Married","2-Widowed","3-Divorced","4-Separated","5-Never Married") )
...
<<mspie, echo=FALSE, fig.pos="ht", fig.align="center",  fig.height=3, fig.cap="Marital Status Pie Chart from GSS 2014 Survey">>=

pie( Percent, labels=c("1-Married","2-Widowed","3-Divorced","4-Separated","5-Never Married")
...
\subsection{Frequency Distribution Table}
 ...
 \begin{figure}[ht]
    \centering
    \includegraphics[width=5.5cm]{chapters/Chapter_2/ext_figure/zRV3.png} % requires the graphicx package
    \caption{Categorical Random Variable}
    \label{fig:RV2}
 \end{figure}
...
YearsOfEducation <- f2_1$educ[f2_1$educ > 0 & f2_1$educ < 89]
