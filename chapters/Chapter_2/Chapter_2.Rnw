...
<<msbar, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=4.8, fig.height=4, fig.cap="Marital Status Barchart from GSS 2014 Survey">>=
...
<<mspie, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=4.8, fig.height=4, fig.cap="Marital Status Pie Chart from GSS 2014 Survey">>=
