...
\subsection{Construct a frequency distribution table for 2014  GSS survey}
...
<<mspie, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=2.8, fig.height=2.8, fig.cap="Marital Status Pie Chart from GSS 2014 Survey">>=
...
\begin{exercises}
 ...
 \end{table}
  ...
  \begin{solution}
    \begin{enumerate}
    \item The percentage of nurses who are female is
      \begin{equation}
      p_f = \frac{116}{315} \times 100 = 36.8\%
      \end{equation}
      
      \item the proportion of orderlies who are  males is 
      \begin{equation}
      p_m = \frac{151}{415}  = 0.367
      \end{equation}
      
      \item the ratio of females to males is 
      
      ratio = 18 females docs to 83 males docs or approxiamately 1 female doc to 5 males docs
      
      \item percentage of females on the staff is 
      \begin{equation}
      p_f = \frac{315}{(315 + 412)} \times 100 = 43.3\%
      \end{equation}
    \end{enumerate}
  \end{solution}
