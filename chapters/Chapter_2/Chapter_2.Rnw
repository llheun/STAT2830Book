...
{\bf{Percents, proportions, rates, and ratio}} are the primary statistics for categorical data and are used for either nominal or ordinal data.
 ...
 \begin{figure}[ht]
    \centering
    \includegraphics[width=5.8cm]{chapters/Chapter_2/ext_figure/zRV2.png} % requires the graphicx package
...
<<msbar, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=5, fig.cap="Marital Status Barchart from GSS 2014 Survey">>=
...
<<mspie, echo=FALSE, fig.pos="ht", fig.align="center",  fig.width=5, fig.cap="Marital Status Pie Chart from GSS 2014 Survey">>=
...
\subsection{Frequency Distribution Table}
 ...
 \begin{figure}[ht]
    \centering
    \includegraphics[width=5.8cm]{chapters/Chapter_2/ext_figure/zRV3.png} % requires the graphicx package
    \caption{Categorical Random Variable}
    \label{fig:RV2}
 \end{figure}
