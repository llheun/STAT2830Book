...
\end{table}
  ...
  \begin{exercise}  % 10
	...
	The town Kalamazoo, Michigan, has a population of 75548 and  experienced 3549 property crimes and 425 violent crimes during the past year.  Compute a rate for each type of crime per 1,000 population.
