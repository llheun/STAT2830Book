...
<<msbar, echo=TRUE, fig.pos="H", fig.align="center",  fig.cap="Marital Status Pie Chart from GSS 2014 Survey">>=
f2_2 <- read.spss("data/GSS2014.sav")
frq2_2 <- table(f2_2$marital)
Percent <- frq2_2 * 100 / length(f2_1$marital)
sort_ms <- sort(Percent, decreasing = TRUE)

sort_ms

#  pie( sort_ms,  main="GSS 2014 Survey on Marital Status" )
@
