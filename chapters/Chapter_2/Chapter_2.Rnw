...
<<t2_1, echo=FALSE>>=
dt2_1 <- read.csv("chapters/Chapter_2/data/sentence.csv",header=TRUE)
...
%    Sentence & Frequency(f) & Proportion & Percent \\ \hline
%    Acquitted & 10 & 0.0372 & 3.72\% \\
%    Suspended & 20 & 0.0743 & 7.43\% \\
%    Less than 5 yrs & 72 & 0.2677 & 26.77\% \\
%    More than 5 yrs & 167 & 0.6208 & 62.08\% \\ \hline
%    Total & 269 & & 100.00\% \\ \hline 
%    
%   \end{tabular}
%   \caption{Frequency Distribution of Court Sentencing results}
%   \label{tab:tab1}
%\end{table} 
