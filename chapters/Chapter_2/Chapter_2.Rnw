...
<<mspie, echo=TRUE, fig.pos="H", fig.align="center",  fig.height=4, fig.cap="Marital Status Pie Chart from GSS 2014 Survey">>=
...
%\begin{figure}[htbp]
%   \centering
%   \includegraphics[width=6cm]{zmaritalSpie.png} % requires the graphicx package
