...
<<msbar, echo=FALSE, fig.pos="H", fig.align="center", fig.width=6, fig.cap="Marital Status from GSS 2014 Survey">>=
f2_1 <- read.spss("data/GSS2014.sav")
frq2_1 <- table(f2_1$marital)
Percent <- frq2_1 * 100 / length(f2_1$marital)
Percent
barplot( Percent, ylab="Percent", xlab="Marital Status", main="GSS 2014 Survey on Marital Status" )
sort_ms <- as.vector(sort(Percent, decreasing = FALSE))
sort_ms; is.vector(sort_ms)
