...
\item Histograms are very useful in examing the ``shape'' of the distribution, for example,: Bell-shaped and symmetrical.  Skewed (left or right),   Multi-modal.
  ...
  \begin{itemize}
  \item Bell-shiped and symmetrical (Figure 2.1)

<<f4_4, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3, fig.height=3, fig.cap="Example of Symmetrical Histogram">>=
 
dt2_2 <- rnorm(n=100,mean=65,sd=4)
hist(dt2_2,xlab="Grades", ylab="Frequency", main="Histogram of Stat 2830 Exam 1")
rm(dt2_2)
@

  \item Right Skewed (Figure 2.2)
  
<<f4_5, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3, fig.height=3, fig.cap="Example of Right Skewed Histogram">>=
 
dt2_2 <- rbinom(n=100, size=20, p=0.15)
