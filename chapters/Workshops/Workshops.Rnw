...
\begin{exercises}
    ...
    \begin{exercise}  % 1-1    
      ...
      A psychologist wants to know the following: Can certain optical illusions fool adults with normal vision?  She randomly selected 50 students from her PSY 120 class and found that 42 of them were fooled by the illusion.  The population in this study is 
...
%       \end{enumerate}
    ...
    \end{solution} 
      ...
      You are writing an article for the college newspaper about the cost of attending college.  You want to make a graph compare costs at your school and three similar schools.  A good choice of a graphic would be a 
...
%       \end{enumerate}
    ...
    \end{solution} 
      ...
      When dealing with financial data (such as salaries or lawsuit settlements), we often find that the shape of the distribution is  \underline{\phantom{xxxxxxxxxx}}.  When the distribution has this shape, the \underline{\phantom{xxxxxxxxxx}} is pulled toward the long tail of the distribution, but the \underline{\phantom{xxxxxxxxxx}} is less affected.  The words that correctly complete this statement are:
...
%       \end{enumerate}
    ...
    <<f13_2_2, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3.1, fig.height=3.1, fig.cap="Mean Comparison">>=
...
%       \end{enumerate}
  ...
  \begin{exercise}  %5-10
    ...
    Using the scenario in exercise 13.5.6, what is your conclustion?
...
%           A cigarette-manufacturing firm distributes two brands of cigarettes. If it is found that 56 of 200 smokers prefer brand A and that 29 of 150 smokers prefer brand B, can we conclude at the 0.05 level of significance that brand A outsells brand B?
          ...
          Using the scenario of exercise 13.6.6, what will happen if a Type II error was committed?
...
\end{table}
      ...
      According to the XYZ news, ``about 3 in 10 Armericans wait more than 20 minutes to have a prescription fill.'' Suppose a comparison of waiting times for pharmacies in HMOs and pharmacies in drugstores produced the following results.  
      
      Is there sufficient evidence to indicate that there is a difference in waiting times for pharmacies in HMOs and pharmacies in drugstores at the five percent level of significances?
...
\end{table}    
      ...
      An exeriment was conducted to compare the effectiveness of four training programs, A, B, C, and D in training assemblers of a piece of equipment.  Twenty (20) employees were randomly assigne, five each, to the four programs.  After completion of the courses, each person was required to assemble four pieces of equipment, and the average length of time required to complete the assembly was recorded.  Two of the employees resigned during the course of the program; the remainer were evaluted, producing the data shown in the Table 13.4.
  
      Do the data provide sufficient evidence to indicate a difference in mean assembly times for people trained by the four programs?
...
%       \end{enumerate}
    ...
    <<f13_7_1, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3, fig.height=3, fig.cap="Comparison Training Methods">>=
      boxplot(dt1~typ1,xlab="Training Types")
@
...
@
         ...
         Using the above table for a post hoc analysis (column 1 (row 1) refers to training method A, column 2 (row 2) refers to training method B, etc.), for example, row 1  column 2 represents the difference between the time to assemble the part using training method A and training method B.  What can we conclude from this table of  differences about the times to assemble a part using the four different training methods?
...
%       \item The differences for the mean assembly time for employees who attended training programs A and B differ as well as the mean assembly time for those who attended training programs A, C, and D.  But the difference for the mean assembly time for employees who attended B and C do not differ differ.
%       \end{enumerate}
      \vspace{1cm}
      \framebox[6cm][l]{ Answer: }
...
\begin{exercises}
  ...
  \begin{exercise}  %8-1 
    ...
    A researcher collected data on two variables  from  15 nations.  The variables are fertility rate (average number of children born to each women), education for females (expressed as a percentage of all students at the secondary level who are females).  

    <<f13_8_3, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3, fig.height=3, fig.cap="Comparison Training Methods">>=
        dt8_3 <- read.csv("data/fertility.csv",header=TRUE)
        plot(dt8_3$EducationOfFemale,dt8_3$FertilityRate)
...
%       \end{enumerate}
  ...
  \begin{exercise}  %8-3 
    ...
    Using the above graph, what is the level of the correlation coefficient, $r$, between the fertility rate and percentage of women at the secondary level (weak, moderate, and strong)?
...
%       \item this is nonsense becuaw correlation makes no sense here.
%       \end{enumerate}
      \vspace{1cm}
      \framebox[6cm][l]{ Answer: }
    ...
    The correlation coefficient between the heights of fathers and the heights of their (adult) sons is $r = 0.52$.  This tells us that 
...
%       \end{enumerate}
    ...
    \begin{exercise}  %8-7 
      ...
      The correlation between the heights of fathers and the heights of their (adult) sons is $r = 0.52$.  
      
      If fathers' heights were measured in feet (one foot equals 12 inches), and sons' heights were measured in furlongs (one furlong equals 7,920 inches), the correlation coefficient between heights of fathers and heights of sons would be 
...
%       \item students who perfer classical music tend to have lower grades.
%       \end{enumerate}
      \vspace{1cm}
      \framebox[6cm][l]{ Answer: }
    ...
    \begin{exercise}  %8-9 
      ...
      A study of child development measures the age (months) at which a child begins to talk and also the child's score on an ability test given several years later.  The study asks whether the age at which a child talks helps that later test score.  The least-squares regression line of the test score $y$ on age $x$ is $y = 110 - 1.3x$.  According to this regression line, what happens (on the average) when a child starts talking one month later? 
...
%       \end{enumerate}
    ...
    \begin{exercise}  %8-10
      ...
      A study showed that students who study more hours tend to do better on statistics exams.  In fact, number of hours studied explained 81\% of the variation in exam scores among the students who participated in the study.  What is the correlation coefficient between hours studied and exam scores?
...
\newpage
    \begin{exercise}  %8-13
      ...
      The least-squares regression line for predicting 1998 percent obese from 1991 percent obese is $y = 7.4 + 0.86x$.  In 1991, 14.8\% of Indiana adults were obese.  Based on this information, what percent would you predict to be obese in 1998?
...
%       \end{enumerate}
    ...
    \begin{exercise}  %8-14
      ...
      Investment advisors  often report correlation coefficients.  For example, the correlation coefficient between gains and losses in large cap stocks and gains and losses in municipal bonds is $r = 0.45$.  This means that the percent of changes in municipal bonds performance that can be explained by the straight line relationship between municipal bonds and large cap stocks is (Hint: think of the coefficient of determination.) -- 
