...
%       \end{enumerate}
    ...
    \begin{exercise}  %8-7 
      ...
      The researcher measured the fathers heights in feet (one foot equals 12 inches), and they measured boys' heights in furlongs (one furlong equals 7,920 inches), the correlation coefficient between heights of fathers and heights of boys would be 
...
%       \end{enumerate}
    ...
    \begin{exercise}  %8-14
      ...
      Investment advisors  often report correlation coefficients.  For example, the correlation coefficient between gains and losses in large cap stocks and gains and losses in municipal bonds is $r = 0.45$ that indicates that the percent of changes in municipal bonds performance that can be described by the straight line relationship between municipal bonds and large cap stocks is (Hint: think of the coefficient of determination.) -- 
