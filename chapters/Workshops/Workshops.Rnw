...
\begin{center}
\begin{flushleft}\textbf{ \large \hfill Workshop 1 Fall 2014 }\end{flushleft}
...
\end{table} 
      ...
      Which state has the highest number of death row prisoners relative to the size of its population?  Question options:
