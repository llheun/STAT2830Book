...
%       \end{enumerate}
    ...
    \end{solution}    
          ...
          \begin{exercise}  %6-5 
            ...
            What will happen if a Type I error was committed?

Question 5 options:
	
It will be concluded that the two methods of learning are equal which is the correct decision.

	
It will be concluded that the two methods of learning are equal when they are not.

	
It will be concluded that the two methods of learning are not equal when they are.

	
It will be concluded that the two methods of learning are not equal which is the correct decision.
