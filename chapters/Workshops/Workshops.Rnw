...
\begin{exercises}
  ...
  \begin{exercise}  %8-1 
    ...
    Data on two variables have been collected for 15 nations.  The variables are fertility rate (average number of children born to each women), education for females (expressed as a percentage of all students at the secondary level who are females).  
...
@
    ...
    Using the above graph, a researcher measured the education of females  in different countries and their fertility rate.  What ?
