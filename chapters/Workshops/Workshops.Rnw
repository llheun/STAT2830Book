...
\pagebreak
    ...
    <<results="asis", echo=FALSE>>=
        ...
        mtx7_10[1,2] <- tt71$estimate[1] - tt71$estimate[2] 
        tt72 <- t.test(dt1[1:4],dt1[9:13])
        mtx7_10[1,3] <- tt72$estimate[1] - tt72$estimate[2]
        tt73 <- t.test(dt1[1:4],dt1[14:18])
        mtx7_10[1,4] <- tt73$estimate[1] - tt73$estimate[2]
        tt74 <- t.test(dt1[5:8],dt1[9:13])
        mtx7_10[2,3] <- tt74$estimate[1] - tt74$estimate[2]
        tt75 <- t.test(dt1[5:8],dt1[14:18])
        mtx7_10[2,4] <- tt75$estimate[1] - tt75$estimate[2]
        tt76 <- t.test(dt1[9:13],dt1[14:18])
        mtx7_10[3,4] <- tt76$estimate[1] - tt76$estimate[2]
