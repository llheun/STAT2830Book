...
\underline{xxxxxxxxxx}.  When the distribution has this shape, the \underline{xxxxxxxxxx} is pulled toward the long tail of the distribution, but the \underline{xxxxxxxxxx} is less affected.  The sequence of words to correctly complete this statement is: 
...
%       \end{enumerate}
    ...
    \end{solution} 
      ...
      For categorical variables (like a person's occupation or sex) it only makes sense to speak of \underline{xxxxxxxxxx}.
It makes no sense to speak of the \underline{xxxxxxxxxx} or the \underline{xxxxxxxxxx} sex.  The sequence of words to correctly complete this statement is 
