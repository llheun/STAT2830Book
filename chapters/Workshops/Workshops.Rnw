...
%       \end{enumerate}
  ...
  \begin{exercise}  %8-3 
    ...
    <<results="asis", echo=FALSE>>=
      xtable(summary(lm8_3))   
    @    
    Using the above table, what is the correlation coefficient, $r$, between the fertility rate and percentage of women at the secondary level?
