...
%       \end{enumerate}
    ...
    <<f13_7_2, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3, fig.height=3, fig.cap="Comparison Training Methods">>=
      boxplot(dt1~typ1,xlab="Training Types")
@
...
@
    ...
    Using the above graph, what is the fertility rate of the nation who has the lowest percentage of women at the secondary level?
...
%       \end{enumerate}
  ...
  \begin{exercise}  %8-5 
    ...
    A study found a correlation $r = 0.43$ between how many cigarettes a person smokes and how overweight the person is.  You conclude that 
...
%       \end{enumerate}
    ...
    \begin{solution}
      ...
      You conclude that this is nonsense becuaw correlation makes no sense here.
...
%       \end{enumerate}
    ...
    \begin{solution}
      ...
      This tells us that taller than average fathers tend to have shorter than average sons.
...
%       \end{enumerate}
    ...
    \begin{exercise}  %8-10
      ...
      A study showed that students who study more hours tend to do better on statistics exams.  In fact, number of hours studied explained 81\% on the variation in exam scores among the students who participated in the study.  What is the correlation between hours studied and exam scores?
...
%       \end{enumerate}
    ...
    \begin{solution}
      ...
      the correlation between hours studied and exam scores is 
      <<results="asis", echo=FALSE>>=
        sqrt(.81)
      @
...
%       \end{enumerate}
    ...
    \begin{exercise}  %8-12
      ...
      Using the scenario from exercise 13.11, the slope of the regression line is  
...
\newpage
    \begin{exercise}  %8-13
      ...
      The least-squares regression line for predicting 1998 percent obsese from 1991 percent obsese is $y = 7.4 + 0.86x$.  In 1991, 14.8\% of Indianan adults were obsese.  Based on this information, what percent would you predict to be obese in 1998?
...
\newpage
    \begin{exercise}  %8-14
      ...
      Investment advisors now often report correlations.  For example, the correlation between gains and losses in large cap stocks and gains and losses in municipal bonds is $r = 0.45$.  This means that the percent of changes in municipal bonds performance that can be explained by the straight line relationship between municipal bonds and large cap stocks is 
...
%       \end{enumerate}
    ...
    \begin{exercise}  %8-15
      ...
      NFL quarterbacks earn more (on the average) that running backs, who in turn earn more than linemen.  The correlation coefficent $r$ between a player's salary and his position.
