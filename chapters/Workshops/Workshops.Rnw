...
<<f13_3_1, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3.3, fig.height=3.3, fig.cap="Mean Comparison">>=
...
<<f13_3_2, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3.3, fig.height=3.3, fig.cap="Mean Comparison">>=

  plot(x10,y10, type="l")
  
@
    
      The standard deviation of the normal distribtion is (Hint: use the empirical rule.)
...
%       \end{enumerate}
    ...
    \begin{solution}
      ...
      The standard deviation of the normal distribtion is 10.
