...
%'       <<f13_2_1, echo=FALSE, fig.pos="ht", fig.align="center",  fig.width=3, fig.height=3, fig.cap="Comparing Calories">>=
%'         poul1 <- runif(17,min=85,max=175)
...
%'         type1 <- c(rep("Poultry", 17), rep("Meat"), 17), rep("Beef"), 20)
%'         boxplot(calories ~ type1, xlab="Protein Type", ylab="Calories")
%'      @ 
        
Above are box plots of the number of calories in 20 brands of beef hotddogs, 17 brands of meat hotdogs, and 17 brands of poultry hotdogs.  The plot shows that 
    ...
    The plot shows that
    most poultry hotdogs brands have fewer calories that most beef and meat hotdogs, but a few poultry hotdogs have more calories that the median beef and meat hotdogs.
     
    \end{solution}
    
    \begin{exercise}  % 2-9
    
    Using the scenario from exercise 2-6, calculate the margin of error. 
...
%'     @  
    ...
    Using the scenario from exercise 2-6, calculate the 95\% confidence interval.
...
%'         \begin{exercise}  % 5
%'     
%'       Using the scenario from exercise 2-4, calculate the 95\% confidence interval.
%' 
%' %       Question options:      
%' %       \begin{enumerate}
%' %       \item (0.3945, 0.4455)
...
%'         prop <- 425/1012
%'         cv1 <- 1.96
%'         se1 <- sqrt((prop*(1 - prop)/1012))
%'         me1 <- cv1 * se1
%'         lb <- prop - me1; lb
%'         ub <- prop + me1; ub
%'         rm(prop, cv1, se1, me1, lb, ub)
%'     @  
%'      
%'     \end{solution}
%'         
...
%' 
%' 
%'       Using the scenario from exercise 2-6, calculate the standard error of your estimate. 
%' 
%' %       Question options:      
%' %       \begin{enumerate}
%' %       \item 0.3444
...
%'     \begin{exercise}  % 2-8
%'        
%'     Using the scenario from exercise 2-6, determine the critical value. 
%' 
%' %       Question options:      
%' %       \begin{enumerate}
%' %       \item 2.703
