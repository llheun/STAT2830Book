...
%       \end{enumerate}
    ...
    \end{solution} 
      ...
      A student reports that of a sample of 200 college undergraduates, 37\% were female and 41\% were male.  We know that the student has made a mistake because Michelle's income two years ago was \$420,000.  Last year her income was only \$100,000.  The percent change in Michelle's income was 
...
\underline{\phantom{3cm}}.  When the distribution has this shape, the \underline{\phantom{3cm}} is pulled toward the long tail of the distribution, but the \underline{\phantom{3cm}} is less affected.  The sequence of words to correctly complete this statement is: 
...
%       \end{enumerate}
    ...
    \end{solution} 
      ...
      For categorical variables (like a person's occupation or sex) it only makes sense to speak of \underline{\phantom{3cm}}.
It makes no sense to speak of the \underline{\phantom{3cm}} or the \underline{\phantom{3cm}} sex.  The sequence of words to correctly complete this statement is 
...
%       \end{enumerate}
    ...
    \end{solution} 
      ...
      What is the first quartile of the observations 2, –2, 1, –1, 1, 0, 0, 3, 0, 2, 3? 
