...
%       \end{enumerate}
    ...
    \begin{exercise}  % 5
      ...
      Using the scenario from exercise 4, calculate the 95\% confidence interval.
...
%       \end{enumerate}
    ...
    \end{solution}
      ...
      Using the scenario from exercise 6, calculate the standard error of your estimate. 
...
%       \end{enumerate}
    ...
    Using the scenario from exercise 6, determine the critical value. 
...
%       \end{enumerate}
    ...
    Using the scenario from exercise 6, calculate the margin of error. 
...
%       \end{enumerate}
    ...
    Using the scenario from exercise 6, calculate the 95\% confidence interval.
