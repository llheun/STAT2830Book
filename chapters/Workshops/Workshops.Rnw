...
%       \end{enumerate}
    ...
    \begin{solution}
      ...
      Tou predict that a person with lean body mass 50 kilograms will have metabolic rate equal to 
      <<results="asis", echo=FALSE>>=
        113.2 + 26.9*50
      @
...
%       \end{enumerate}
    ...
    \begin{exercise}  %8-15
      ...
      NFL quarterbacks earn more (on the average) than running backs, who in turn earn more than linemen.  The correlation coefficent $r$ between a player's salary and his position.
...
%       \end{enumerate}
    ...
    \begin{solution}
      ...
      The correlation coefficent $r$ between a player's salary and his position makes no sense.
