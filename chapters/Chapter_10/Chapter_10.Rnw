...
\begin{exercises}
  ...
  \end{solution}
    ...
    STEP 1: The next five exercises, we will use the data in exercise three.  We have been asked to research the following question: Why do respondents have a gun in their home?  {\it{Have a gun in home}} is the dependent variable or the rows of our table.  So step 1 in the process of analysis is to choose the independent variable.  In this case, let's review the table:
...
What independent variable did we choose? 
  ...
  \end{solution}
    ...
    STEP 2: Using the information from exercise three, we must state the {\it{hypotheses}} about its relationship with {\it{having a gun in home.}}  
...
\end{table}
  ...
  \end{solution}  
    ...
    \begin{enumerate}
    \item Discern the variables tested, vis, the value and significance of the chi-square, sample size, and any pattern in the column percentages.
    \item Does the data support our hypotheses?
    \end{enumerate}
    
    For example: For a sample of 249 subjects, there was a significant relationship between gender and income (chi-square = 35, degrees of freedom = 1, and p-value = .000).  About 50 percent of men say that there is no difference vs. about 30 percent of women.
