...
What independent variable did we choose? 
  ...
  \end{solution}
    ...
    Using the information from exercise three, we must state the {\it{hypotheses}} about its relationship with {\it{having a gun in home.}}  
