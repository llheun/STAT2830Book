...
\begin{exercises}
  ...
  \end{solution}
   ...
   \centering
   \includegraphics[width=9cm]{chapters/Chapter_10/ext_figure/gun2.pdf} 
   \caption{SPSS output}
   \label{fig:f93}
\end{figure}
...
Based on our experience, how should we state our hypotheses?  
  ...
  \begin{solution}
	  ...
	  The hypotheses for this scenario is $H_0:$ Gender and having a gun in home are independent, vs. $H_1:$ Gender and having a gun in home are dependent.
