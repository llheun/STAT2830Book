...
\begin{exercises}
  ...
  \begin{exercise}
    ...
    A random sample of 100 HBO movies contain an average of 3.38 acts of physical violence per program.  Find the 95 percent confidence interval for the `true' average number of acts of physical violence per program given the information below:
  ...
  \begin{exercise}
	...
	\end{exercise}
	\begin{solution}
	    $SE = \frac{s}{\sqrt{n}} = \frac{0.30}{\sqrt{100}} = 0.03$
	\end{solution}
