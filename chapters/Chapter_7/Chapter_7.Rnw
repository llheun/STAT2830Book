...
<<f7_1, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=4, fig.height=4.5, fig.cap="50 samples from same population">>=

dddd1 <- runif(120,min=88,max=120);
popxbar <- mean(dddd1);
popsd    <- sd(dddd1);

mx1 <- popxbar + 0.7 * popsd;
mn1 <- popxbar - 0.7 * popsd;
