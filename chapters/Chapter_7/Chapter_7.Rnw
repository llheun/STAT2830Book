...
\item Thus, we are 95 percent confident that the true population proportion for readmission to program for alcoholism and drug dependency is between 43.2\% and 62.8\%.  
\end{enumerate}
