...
xSW <- read.csv('data/SWper100K.csv', header=FALSE)
@
...
<<SW1, echo=FALSE, fig.path="figure/", fig.align="center", fig.width=4, fig.height=4, out.width="3cm", fig.show="hold", par=TRUE, fig.cap="SW/100K">>=
       hist(xSW[,2], xlab=' ', col='skyblue')
@
