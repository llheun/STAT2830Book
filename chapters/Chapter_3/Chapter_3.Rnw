...
The \emph{mean} (usually denoted as $\bar{x}$) is defined as an average of values in the dataset.  It is the most commonly utilized measure.  
...
It is often important to know what is the distribution in the dataset, or more xxx if there is symmetry xxx or is the dataset skewed.
