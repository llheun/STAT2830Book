...
An illustration of the interquartile range (IQR) of a variable.  We will use data from the GSS 2014, Years of Education of the United Stats households.  See Figure 4.2.
