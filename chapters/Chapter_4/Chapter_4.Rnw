...
\item describes the ``average'' or typical squred deviation of the scores.  The statistic should give us an idea about how far scores are from each other or from the center of the distribution.
...
The coefficient of variation is defined \\ $ CV = \frac{s}{\bar{x}} \times 100\%$
