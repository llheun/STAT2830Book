...
<<f4_4, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3, fig.height=3, fig.cap="Campus Comparison">>=
...
The following graphic shows the representation of the standard deviation.
