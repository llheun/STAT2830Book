...
(spread) in the data.
\item It only includes information from two of the data values, has limited power for interpretation, and 
 has limited use in more advanced statistical analysis of problems.
\end{itemize}

\section{Interquartile Range}

An illustration of the interquartile range of a variable.
