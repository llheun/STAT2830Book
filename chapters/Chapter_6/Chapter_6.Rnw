...
\end{minipage}
 ...
 \item Answer: NO!  99.84 percent of the group averages will be within 66.2 and 72.0 inches tall.
 ...
 \item But using the average height of men in the United States, we find that 99.84 percent of the group means will be from 66.2 and 72.0 inches.
 \end{itemize}
