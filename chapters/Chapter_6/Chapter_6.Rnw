...
\samepage
\item A representative sample has to be selected based on  {\bf{randomness}}.
\end{itemize}
...
\begin{enumerate}
\item {\bf{Coverage errors}} -- sampling frame \footnote{a sampling frame is the source material or device from which a sample is drawn}
...
\end{minipage}
 ...
 \item But using the average height of men in the United States, we find that 99.84 percent of the groups averages will be from 66.2 and 72.0 inches.
 \end{itemize}
...
\begin{exercises}
	...
	\begin{exercise}
	  ...
	  A recent Poll showed that 69 percent of Americans believe that there is a hell.  The poll contacted 1,003 adults by telephone.  The population for this sample survey is
		  \begin{enumerate}
	 	  \samepage
	...
	\begin{exercise}
	  ...
	  An auditor has come to audit the books of your non-profit organization,.  She randomly chooses one of the first ten entries of the ledger.  This entry and every tenth entry is selected.  This method is called
		  \begin{enumerate}
		  \samepage
		  \item cluster sampling
		  \samepage
	...
	\begin{exercise}
	  ...
	  The national norm of a science test for tenth graders has a mean of 210 and a standard deviation of 28.  A random sample of 40 tenth graders were selected.  What is the chance that this group will average over 220?
		  \begin{enumerate}
		  \item 0.0
		  \item 0.0199
		  \item 0.3605
