...
\item Interpret the correlation coefficient $r$ and $r^2$.
...
\item Coefficient of determination:
  ...
  \item The explained variation is measured from the average of the \emph{Y}-variable to the predicted \emph{Y}-variable.
  \item The unexplained variation is measured from the observed \emph{Y}-variable to the predicted \emph{Y}-variable.
  \item The total variation is measured from the observed \emph{Y}-variable to the average of the \emph{Y}-variable.
  \end{itemize}
...
beer. Thirty minutes later, a police officer measured their blood alcohol content (BAC). 
% A scatterplot of the data appears below.  
One student drank 9 beers. You see from the scatterplot that his BAC was about
