...
What can predict the final exam score of a Introductory Statistics course?  Statistics instructors have been asking this question for a long time.  An instructor gathered data from 64 of her statistics class students and did the following analysis.  
