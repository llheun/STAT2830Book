...
\end{figure}    
  ...
  \begin{exercise} % 4
    ...
    In this exercise, our dependent variable is the respondent's {\it{rincom06}} from GSS2014 dataset.  
...
x12_2 <- x12_1[ (dt12_1$HEIGHT > 0 & dt12_1$HEIGHT < 98) & 
						  (dt12_1$rincom06 > 0 & dt12_1$rincom06 < 26),  ]          ## select only valid data
nrw12 <- length( x12_2[ , 1] ); nrw12 
x12_3 <- x12_2[ sample( 1:nrw12, size= 40, replace = TRUE),  ]
x12 <- x12_3[,1]
y12 <- x12_3[,2]
plot(x12,y12, xlab="Height (inches)", ylab="Income (K dollars)", main="Scatterplot Respondent's Height vs. Income" )
m12 <- lm(y12 ~ x12)
abline(m12)
summary(m12)
