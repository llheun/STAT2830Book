...
\begin{table}[htbp]
   ...
   \begin{tabular}{@{} ll @{}} \hline % Column formatting, @{} suppresses leading/trailing space
      ...
      Model: &  Random sampling  \\
             ...
             & Linear relationship \\
             & Variance of \emph{Y} scores is uniform for all \emph{X} values.
...
\item Step 4.  Computing the Test Statistic.
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=6cm]{chapters/Chapter_12/ext_figure/zCorrA.png} % requires the graphicx package
