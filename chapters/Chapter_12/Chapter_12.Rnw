...
x12_10 <- x12_15[ (dt12_5$HEIGHT > 0 & dt12_5$HEIGHT < 98) & 
						  (dt12_5$rincom06 > 0 & dt12_5$rincom06 < 26) &
						  (dt12_5$age  > 0) & (dt12$age < 98) &
...
Age    <- x12_11[,3]
TVhours<- x12_11[,4]
## plot(Height, Income + Age + TVhours, xlab="Height (inches)", ylab="Income (K dollars)", main="Scatterplot of Height vs. Income" )

cor13 <- cor(Income, Height, Age, TVhours )
rSq   <- cor13 * cor13
