...
\item Where 
  \begin{itemize}
  \samepage
  \item Final -- Final exam
  \samepage
  \item MT1 -- Midterm 1 exam
  \samepage
  \item MT2 -- Midterm 2 exam
  \samepage
  \item Proj -- Project
  \samepage
  \item HW -- Homework
...
<<f12_8, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3.5, fig.height=3.5, fig.cap="Residual Plot">>=
  
  plot( dt12_3$residuals ~ dt12_3$fitted.values, xlab="Final -- fitted values ", ylab="Residuals")
