...
<<f12_16, echo=FALSE, fig.pos="ht", fig.align="center", fig.width=3.5, fig.height=3.5, fig.cap="Respondent's Height vs. Income">>=
...
##  xtable(cor13)
  ...
  m14 <- lm( Happiness ~  Income + Age + NotMarried )
