...
The next step is to determine the regression equation.  
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=11cm]{chapters/Chapter_12/ext_figure/zRegE.png} % requires the graphicx package
    \caption{SPSS Regression Analysis }
    \label{fig:f12_8}
 \end{figure}
...
\begin{itemize}
\item The is one other thing that we should look at is the residuals.  
  \begin{itemize}
  \item 
  \begin{equation}
  ...
  \item The histogram of the residuals should be a bar-shaped.
  \item 
