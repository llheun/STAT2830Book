...
What can predict the final exam score of a Introductory Statistics course?  Statistics instructors have been asking this question for a long time.  An instructor gathered data from 64 of her statistics class and did the following analysis.  
...
\begin{table}[htbp]
   ...
   \begin{tabular}{@{} lccccc @{}} \hline % Column formatting, @{} suppresses leading/trailing space
      ...
      % \cmidrule(r){1-2} % Partial rule. (r) trims the line a little bit on the right; (l) & (lr) also possible
      Statistics & Final & Midterm 1 (MT1) & Midterm 2 (MT2) & Project & Homework (HW) \\ \hline
      Mean & 155.0 & 86.1 & 74.2 & 10.1 & 72.3 \\
      Standard deviation & 26.63 & 11.51 & 18.59 & 1.16 & 11.69 \\
...
One well known school of criminology has  argued that  
