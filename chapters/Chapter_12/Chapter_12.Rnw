...
x12_10 <- x12_9[ (dt12_5$happy > 0 & dt12_5$HEIGHT < 8) & 
						  (dt12_5$income > 0 & dt12_5$income < 13) &
...
NotMarried <- x12_11[,4]
  ...
  m13 <- lm( Happiness ~  Income + Age + NotMarried )
...
What are the dependent and independent variables?
    ...
    \vspace{2mm}
    \begin{solution}
       The independent variable is income and  age and the dependent variable is happiness.
    \end{solution}    
  ...
  \begin{exercise} % 10
    ...
    STEP 2: Using the information from exercise nine, we must state the hypotheses about its relationship between {\it{Happines}}, {\it{income}}, and {\it{age}}.  Based on our experience, how should we state our hypotheses?
    ...
    \begin{solution}
       ...
       where $\beta_1$ is the slope for Happiness and Income, and $\beta_2$ is the slope for Happiness and Age.
