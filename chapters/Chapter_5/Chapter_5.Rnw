...
\begin{exercises} 
  ...
  \begin{exercise} 
    ...
    Given a distribution of male weights  has a mean of 153 lbs. and standard deviation of 11 lbs., how many standard deviations away from the mean weight is 173 lbs.?
	  \begin{enumerate}
	  \item $-1.82$
	  \item 1.82
	  \item 1.82 lbs.
