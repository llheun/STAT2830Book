...
Suppose you are concerned about the amount of money that students pay for their lunch.  The average lunch costs five (5) dollars with a standard deviation of \$0.50.  Use the empirical-rule to determine the 68-95-99.7 percent of student lunch expense. 
...
\item So how do we interpret this data.  It is telling us that on the average college students spend about 5.5 hours on the world-wide web give or take 19.5 hours.
