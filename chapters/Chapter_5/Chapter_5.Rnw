...
\item Another way of stating this result is that  if you were to randomly select an individual male from the population, the probability that the individual has an IQ score of 130 or greater is 0.0668.
