...
The Empirical Rule states that if the population of a dataset has a bell-shaped distribution with population mean $\mu$ and standard deviation $\sigma$ then following conditions are true: 
