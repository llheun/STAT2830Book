...
\begin{exercises}
  ...
  \begin{exercise} 
    Given a distribution of male weights  has a mean of 153 lbs. and standard deviation of 11 lbs., how many standard deviation away from the mean weight is 173 lbs.?
	  \begin{enumerate}
	  \item $-1.82$
	  \item 1.82
	  \item 1.82 lbs.
	...
	\begin{solution}
	  \begin{equation}
	    \frac{173 - 153}{11} = 1.82 lbs
	  \end{equation}
	\end{solution}  
	
  \begin{exercise} 
    Given the distribution of male weights has mean of 155 and standard deviation of 12, what percent 
of males weight less than 143 pounds?
  ...
  \begin{exercise} 
    Given the distribution of male weights with mean of 155 and standard deviation of 12, what value 
