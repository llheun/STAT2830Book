...
The \emph{normal curve} is the single most important theory in the social sciences. We can describe it by the bell-shaped curve.  It allows us to determine the probability of an event when we have the mean and standard deviation.
